...
class PUE extends Service_Provider {
	 ...
	 * @var string
	 */
	private static $pue_slug = 'extension-show-additional-field-on-attendee-page';
	...
	public function register() {
		...
		$this->container->singleton( 'extension.show_additional_field_on_attendee_page.pue', $this );
